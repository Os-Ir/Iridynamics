...
public class ModSolidShapes {
    public static final SolidShape DUST = new SolidShape("dust", null, 144, flag(MaterialBase.GENERATE_DUST));
    ...
    public static final SolidShape DOUBLE_PLATE = new SolidShape("double_plate", null, 288, flag(MaterialBase.GENERATE_PLATE));
    public static final SolidShape CURVED_PLATE = new SolidShape("curved_plate", null, 144, flag(MaterialBase.GENERATE_PLATE));
    public static final SolidShape ROD = new SolidShape("rod", null, 72, flag(MaterialBase.GENERATE_ROD));
    public static final SolidShape SHORT_ROD = new SolidShape("short_rod", null, 36, flag(MaterialBase.GENERATE_ROD));
    public static final SolidShape LONG_ROD = new SolidShape("long_rod", null, 144, flag(MaterialBase.GENERATE_ROD));
    public static final SolidShape GEAR = new SolidShape("gear", null, 576, flag(MaterialBase.GENERATE_GEAR));
    public static final SolidShape SMALL_GEAR = new SolidShape("small_gear", null, 144, flag(MaterialBase.GENERATE_GEAR));
    public static final SolidShape CRYSTAL = new SolidShape("crystal", null, 144, flag(MaterialBase.GENERATE_CRYSTAL));
    ...
    public static final SolidShape DOUBLE_INGOT = new SolidShape("double_ingot", null, 288, flag(MaterialBase.GENERATE_INGOT));
    public static final SolidShape FOIL = new SolidShape("foil", null, 36, flag(MaterialBase.GENERATE_FOIL));
    public static final SolidShape SCREW = new SolidShape("screw", null, 18, flag(MaterialBase.GENERATE_SCREW));
    ...
    public static final SolidShape HAMMER_HEAD = new SolidShape("hammer_head", null, 144, flag(MaterialBase.GENERATE_TOOL));
    public static final SolidShape CHISEL_HEAD = new SolidShape("chisel_head", null, 144, flag(MaterialBase.GENERATE_TOOL));
