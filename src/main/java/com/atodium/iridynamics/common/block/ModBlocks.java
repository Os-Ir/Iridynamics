...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CLOCKWORK = Iridynamics.REGISTRY.block("clockwork", HandleBlock::new, Material.WOOD).strength(3.0f, 2.0f).sound(SoundType.WOOD).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
