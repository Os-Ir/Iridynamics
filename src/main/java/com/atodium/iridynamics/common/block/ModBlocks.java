...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MULTIBLOCK_CRUCIBLE = Iridynamics.REGISTRY.block("multiblock_crucible", MultiblockCrucibleBlock::new, Material.STONE).strength(4.0f, 2.0f).sound(SoundType.STONE).registerWithItem(ModCreativeTabs.EQUIPMENT);
    ...
    public static final RegistryObject<Block> WOOD_AXLE = Iridynamics.REGISTRY.block("axle", (properties) -> new AxleBlock(properties, AxleBlock.AxleType.WOOD), Material.WOOD).strength(2.0f, 1.0f).sound(SoundType.WOOD).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
    public static final RegistryObject<Block> BRONZE_AXLE = Iridynamics.REGISTRY.block("bronze_axle", (properties) -> new AxleBlock(properties, AxleBlock.AxleType.BRONZE), Material.METAL).strength(4.0f, 2.0f).sound(SoundType.METAL).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
    public static final RegistryObject<Block> STEEL_AXLE = Iridynamics.REGISTRY.block("steel_axle", (properties) -> new AxleBlock(properties, AxleBlock.AxleType.STEEL), Material.METAL).strength(4.0f, 2.0f).sound(SoundType.METAL).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
    ...
    public static final RegistryObject<Block> CLOCKWORK = Iridynamics.REGISTRY.block("clockwork", ClockworkBlock::new, Material.WOOD).strength(3.0f, 2.0f).sound(SoundType.WOOD).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
    public static final RegistryObject<Block> BELT_PULLEY = Iridynamics.REGISTRY.block("belt_pulley", BeltPulleyBlock::new, Material.WOOD).strength(2.0f, 1.0f).sound(SoundType.WOOD).noOcclusion().registerWithItem(ModCreativeTabs.EQUIPMENT);
    ...
    public static final RegistryObject<Block> GRINDER = Iridynamics.REGISTRY.block("grinder", GrinderBlock::new, Material.METAL).strength(6.0f, 4.0f).sound(SoundType.METAL).registerWithItem(ModCreativeTabs.EQUIPMENT);
