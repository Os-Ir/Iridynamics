...
public class ToolWrench extends MaterialToolBase {
    public static final ResourceLocation REGISTRY_NAME = Iridynamics.rl("wrench");
    public static final ToolWrench INSTANCE = new ToolWrench();
